      ...
      <div className="text-gray-700">
         <h3 className="text-lg md:text-xl text-gray-700 md:w-10/12 mt-8">
          ...
          <p className="text-gray-500 text-xs md:text-base font-light w-6/6 mt-5">
            Lors de votre navigation sur nicolascastera.fr, nous recueillons des
          ...
          <p className="text-gray-500 text-xs md:text-base font-light w-6/6 mt-5">
            ...
            services pertinents. nicolascastera.fr peut choisir de revendre ces
          ...
          <p className="text-gray-500 text-xs md:text-base font-light w-6/6 mt-5">
            La sécurité de vos données est primordiale pour nous. nicolascastera.fr
          ...
          <p className="text-gray-500 text-xs md:text-base font-light w-6/6 mt-5">
            nicolascastera.fr se réserve le droit de modifier cette politique de
